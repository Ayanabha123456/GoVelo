...
const RepairForm = (props) => {
    ...
    let tableRows = props.vehicleData.map(vehicle => <tr>
        <td style={{ padding: '15px' }}><p>{vehicle[0]}</p></td>
                        ...
                        <table style={tableStyles}>
                            <thead style={{ borderBottom: '2px solid rgb(76,154,42)' }}>
                                <tr>
                                    ...
                                    <th style={{ padding: '15px', borderBottom: '2px solid rgb(76,154,42)', borderTop: '2px solid rgb(76,154,42)' }}>Defect</th>
                                </tr>
                            </thead>
                            <tbody>
                                {tableRows}
